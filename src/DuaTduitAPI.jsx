...
const DuaTduit = ({ user, onLogout }) => { // ✅ Terima props
  ...
  const incomeSources = ['Gaji', 'Bonus', 'Hadiah', 'Freelance', 'Bisnis', 'Lainnya'];
  const expenseCategories = ['Makan & Minum', 'Transportasi', 'Hiburan', 'Belanja', 'Tagihan', 'Kesehatan', 'Pendidikan', 'Lainnya'];
          ...
          <div className="space-y-3 max-h-96 overflow-y-auto">
            {filteredTransactions.length === 0 ? (
              ...
              filteredTransactions.map((t) => {
                ...
                const categoryData = isIncome ? incomeCategories.find(c => c.value === t.category) : null;
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-1">
                            <h3 className={`font-semibold ${darkMode ? 'text-white' : 'text-gray-800'}`}>
                              {isIncome ? categoryData?.label || t.category : t.source}
                            </h3>
